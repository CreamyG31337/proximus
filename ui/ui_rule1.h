...
**
** Created: Tue Aug 2 00:38:44 2011
...
public:
    ...
    void setupUi(QDialog *Rule1)
    {
        ...
        locGridLayout->addWidget(lblLat, 0, 0, 1, 1);
        ...
        locGridLayout->addWidget(txtLocLongitude, 1, 1, 1, 1);
